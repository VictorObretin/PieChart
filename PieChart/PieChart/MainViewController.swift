...
class MainViewController: UIViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    func populateControllersArray() {
        ...
        controller = storyboard!.instantiateViewController(withIdentifier: "VariableSlices") as! VariableSlicesViewController
        controller.itemIndex = 1
        controller.view.backgroundColor = UIColor.clear
        _controllers.append(controller)
        
        controller = storyboard!.instantiateViewController(withIdentifier: "HollowPie") as! HollowPieViewController
        controller.itemIndex = 2
        controller.view.backgroundColor = UIColor.clear
        _controllers.append(controller)
        
        controller = storyboard!.instantiateViewController(withIdentifier: "ClassicPie") as! ClassicPieViewController
